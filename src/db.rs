...
mod tests {
    ...
    async fn test_get_task() {
        ...
        let created = create_task(&pool, "Find Me", "Description")
            .await
            .unwrap();
    ...
    async fn test_list_tasks_multiple() {
        ...
        let task1 = create_task(&pool, "Task 1", "Description 1")
            .await
            .unwrap();
        let task2 = create_task(&pool, "Task 2", "Description 2")
            .await
            .unwrap();
        let task3 = create_task(&pool, "Task 3", "Description 3")
            .await
            .unwrap();
